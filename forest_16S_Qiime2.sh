...
#primer: V4: 515F-806R GTGCCAGCMGCCGCGGTAA-GGACTACHVGGGTWTCTAAT
...
#forest_change sample name
#import os
#import pandas
#import shutil
#datapth = r'/home/liuyaping/GW/northforest_rawdata/forest_raw_data/soil_fungi'
#spth = r'/home/liuyaping/GW/northforest_rawdata/forest_raw_data/soil_fungi_rename/'
#filelist = os.listdir(datapth)
#excel = pd.read_excel(r'/home/liuyaping/GW/northforest_rawdata/扩增子数据分析样品命名.xlsx')

#for filename in filelist:
	#print('filename:',filename)
	#label = filename.split('_')[0]
	#print('step 1:',label)
	#index = excel['样品分析名称']==int(label)
	#label2 = excel[index]['Summary name'].values[0]
	#print('Step 2:',label2)
	#updatelabel = label2 + '_'+('_').join(filename.split('_')[1:])
	#print('Step 3:',updatelabel)
	#shutil.copy(os.path.join(datapth,filename),os.path.join(spth,updatelabel))
	#break
...
SEQ="/home/dell/02Data/Forest/16S_20240603"
OUT="/home/liuyaping/GW/northforest_rawdata/16S"
...
#fastqc -t 4 /home/dell/02Data/MuUs/MuUs_180sample_202309/16S/* \
#-o $OUT/fastqc_out/
